...
ActiveRecord::Schema.define(version: 2021_01_15_072043) do
  ...
  create_table "regular_expressions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", null: false
    t.text "text", null: false
    t.string "url_text"
    t.bigint "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_regular_expressions_on_user_id"
  end
